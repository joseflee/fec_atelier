...
class RatingsAndReviews extends React.Component {
  ...
  //   var reviewCount = this.props.reviews.results.length;
  //   var characteristics = this.props.ratingsMeta.characteristics;
  ...
  render() {
    return (
      <div id="reviewsSection">
        ...
        <Sort handleSort={this.props.handleSort} reviewCount={this.props.reviewCount} />
        <RatingBreakdown averageRating={this.props.averageRating} percent={this.props.percent} reviewCount={this.props.reviewCount} filterByStars={this.props.filterByStars} ratingsMeta={this.props.ratingsMeta} />
        <ProductBreakdown ratingsMeta={this.props.ratingsMeta} descriptions={this.props.descriptions} />
        <ReviewsList reviews={this.props.currentReviews} visibleReviews={this.props.visibleReviews} characteristics={this.props.characteristics} ratings={this.props.ratingsMeta.ratings} productId={this.props.productId} handleMoreReviews={this.props.handleMoreReviews} descriptions={this.props.descriptions}/>
      </div>
